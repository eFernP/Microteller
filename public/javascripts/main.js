...
const main = () => {
    ...
    function postAddFav(event) {
        ...
        if (heart) {
            ...
            axios.post('https://Microtellered.herokuapp.com/stories/remove-favorite', { id })
                .then(response => {
            ...
            intNumber++;
            number.innerText = intNumber;
            axios.post('https://Microtellered.herokuapp.com/stories/add-favorite', { id })
                .then(response => {
                    //console.log("You just created this character: ", response.data);
    ...
    function postVote(event) {
        ...
        axios.post('https://Microtellered.herokuapp.com/stories/add-vote', { id })
            .then(response => {
    ...
    function addComment(event) {
        ...
        axios.post(`https://Microtellered.herokuapp.com/stories/${id}/comment`, {text})
            .then(response => {
